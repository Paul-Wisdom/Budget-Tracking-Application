...
Router.post('/api/get-expense/all', authController.protectedRoute, budgetController.getAllExpenses);
...
Router.post('/api/get-income/all', authController.protectedRoute, budgetController.getAllIncome);
